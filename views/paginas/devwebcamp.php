    ...
    <p class="devwebcamp__descripcion">Descubre el evento de desarrollo web más relevante de toda Pangea. Lugares situados fuera del Trópico de Cáncer y de Capricornio quedan excluidos.</p>
     ...
     <div class="devwebcamp__grid">
        ...
        <div class="devwebcamp__contenido">
            ...
            <p class="devwebcamp__texto">Nulla turpis erat, egestas quis tincidunt sed, interdum sed quam. Praesent fermentum tempus viverra. Curabitur consequat mattis massa nec fermentum. Proin lacinia tristique bibendum. Aenean tellus erat.</p>
        </div>
     </div>
     <div class="devwebcamp__final">
